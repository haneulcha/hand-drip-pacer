        ...
        {options.map((opt, i) => (
          <div
            ...
            style={{
              ...
              borderRight:
                i < options.length - 1 ? `1px solid ${INK_FAINT}` : "none",
          ...
          >
            <Label
              size={12}
              color={opt === value ? INK : INK_SOFT}
              weight={opt === value ? 600 : 400}
    ...
    <SketchBox width={width} height={height} seed={seed} radius={8}>
      <div style={{ display: "flex", alignItems: "center", height: "100%" }}>
        <div style={{ flex: "0 0 36px", textAlign: "center" }}>
          <Label size={18} weight={400} color={INK_SOFT}>
            −
          </Label>
        </div>
        <div style={{ flex: 1, textAlign: "center" }}>
          ...
          {unit && (
            <Label size={11} style={{ marginLeft: 2 }}>
              {unit}
            </Label>
          )}
        </div>
  ...
  return (
    <div style={{ width, position: "relative", paddingTop: 4 }}>
      ...
      >
        ...
        <Num size={14}>
          {value}
          <Label size={10} color={INK_SOFT} style={{ marginLeft: 2 }}>
            {unit}
          </Label>
        </Num>
        <Label size={10} color={INK_FAINT}>
  ...
  for (let i = 0; i < 24; i++) {
    ...
    ticks.push(
      <line
        ...
        x2={x2}
        y2={y2}
        stroke={hv ? INK : INK_FAINT}
        strokeWidth={hv ? 1.2 : 0.8}
        strokeLinecap="round"
      />,
    );
  }
  ...
  return (
    <svg width={width} height={height} style={{ overflow: "visible" }}>
      ...
      <g transform={`translate(${cx - 28}, ${pad - 4})`}>
        <path
          d="M 0 0 L 56 0 L 44 22 L 12 22 Z"
          fill="none"
          stroke={INK}
          strokeWidth={1.2}
          strokeLinejoin="round"
